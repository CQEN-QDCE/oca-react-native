...
<html>
  ...
  <body>
    <div id="app" style="margin-top: 0px;background-color:transparent;"></div>
    <script>
        function renderOCACredential (structure, data, config, layout) {
            ...
            app.style.height = layout.config.height
        };
    </script>
    <script>
    function generateOCACredential (structure, data, config, layout) {
        ...
        iframe.style.cssText = 'width: 100%; height: 100%; border: none;background-color:transparent;';
        iframe.scrolling = 'no';
        ...
        availableLanguages.forEach((language, i) => {
            ...
            credential.style.width = '100%';
            credential.style.height = '100%';
            if (i != 0) {
